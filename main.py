...
if __name__ == "__main__":
    # Start the health-check HTTP server in a daemon thread FIRST.
    # Pure Python threading — completely separate from asyncio.
    # No event-loop conflicts with Pyrogram whatsoever.
    start_health_server()

    # Run the async bot on a clean event loop.
    asyncio.run(main())
